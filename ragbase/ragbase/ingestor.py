...
class Ingestor:
    def __init__(self, db_path: Optional[Path] = None):
        # Allow a custom db_path per session to avoid Qdrant file locks
        self.db_path = db_path or Config.Path.DATABASE_DIR
    ...
    def ingest(self, doc_paths: List[Path]) -> VectorStore:
        ...
        return Qdrant.from_documents(
            ...
            path=str(self.db_path),          # use session-specific path
